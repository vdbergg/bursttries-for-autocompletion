...
#ifndef BEVA_CPT_BFS_STATICSTRING_H
#define BEVA_CPT_BFS_STATICSTRING_H
...
namespace beva_cpt_bfs {
    ...
    public:
        ...
        StaticString(unsigned long data, long unsigned size) {
            this->dataPos = data;
...
#endif //BEVA_CPT_BFS_STATICSTRING_H
