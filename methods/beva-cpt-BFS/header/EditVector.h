...
#ifndef BEVA_CPT_BFS_EDITVECTOR_H
#define BEVA_CPT_BFS_EDITVECTOR_H
    ...
    public:
        ...
        void print() {
            for (int i = 0; i < size; i++) {
                if (vectorChar.vector[i] > editDistanceThreshold) cout << "# ";
                else cout << (int) (vectorChar.vector[i]) << " ";
            }
            cout << endl;
        }
...
#endif //BEVA_CPT_BFS_EDITVECTOR_H
