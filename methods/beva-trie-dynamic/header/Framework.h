...
#ifndef BEVA_TRIE_DYNAMIC_FRAMEWORK_H
#define BEVA_TRIE_DYNAMIC_FRAMEWORK_H
...
namespace beva_trie_dynamic {
    ...
    public:
        ...
        vector<char *> output(vector<ActiveNode> &currentActiveNodes, const string &basicString);
...
#endif //BEVA_TRIE_DYNAMIC_FRAMEWORK_H
